...
\fbox{
    \parbox{\textwidth}{
        ...
        \textbf{Mensa}(\underline{Dienststellennummer}, \underline{Name}, \underline{Ort}, Personalnummer)\\
        \textbf{Gericht}(\underline{Referenznummer}, Name, Beschreibung, Angebotart, MenueGang, Bewertung, Mensa)\\
        \textbf{Zutat}(\underline{Bestellnummer}, Bezeichnung, MHD, Allergika, IstVegetarisch)\\
        \textbf{Rezept}(\underline{GerichtId}, \underline{ZutatId})\\
    }
}
